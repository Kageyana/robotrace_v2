...
// シンボル定義
//====================================//
#define MOTOR_COUNTERPERIOD htim2.Init.Period

#define PWMOUT_L      __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, (int16_t)((float)pwmL/1000*MOTOR_COUNTERPERIOD))
#define PWMOUT_R      __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, (int16_t)((float)pwmR/1000*MOTOR_COUNTERPERIOD))
