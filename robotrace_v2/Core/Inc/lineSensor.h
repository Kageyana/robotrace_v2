...
#define TRACE_CROSSLINE_LOW_REFLECT_THRESHOLD	300	// クロスライン判定用の正規化値しきい値
#define TRACE_CROSSLINE_MIN_COUNT		2	// クロスライン検出の開始条件とする低反射センサ数
#define TRACE_CROSSLINE_RELEASE_COUNT	1	// クロスライン解除条件とする低反射センサ数
