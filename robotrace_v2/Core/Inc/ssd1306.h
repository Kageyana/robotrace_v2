...
#define SSD1306_CMD_LEN       8                                    // コマンド列のバイト数
#define SSD1306_DMA_BUFFER_SIZE   (SSD1306_BUFFER_SIZE + SSD1306_CMD_LEN) // DMA送信用バッファサイズ
...
void ssd1306_I2C_MasterTxCpltCallback(I2C_HandleTypeDef *hi2c); // I2C送信完了処理
