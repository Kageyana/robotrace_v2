...
#define TRACE_WEIGHT_CENTER		1.00f
...
// BOOST_DISTANCE低速カーブで過大なライン角速度目標を抑える採用設定
#define LINE_TRACE_OMEGA_TARGET_CAP_ENABLE 1
#define LINE_TRACE_OMEGA_TARGET_CAP_ABS_DEG_S 1200
#define LINE_TRACE_OMEGA_TARGET_CAP_MAX_SPEED_PULSE 90
#define LINE_TRACE_OMEGA_CURVE_FF_ENABLE 1
#define LINE_TRACE_OMEGA_CURVE_FF_ROC_MAX_MM 200
#define LINE_TRACE_OMEGA_CURVE_FF_ROC_MIN_MM 80
#define LINE_TRACE_OMEGA_CURVE_FF_MAX_SPEED_PULSE 95
#define LINE_TRACE_OMEGA_CURVE_FF_GAIN_PCT 100
#define LINE_TRACE_OMEGA_CURVE_FB_SCALE_PCT 35
...
#define SPEED_FEEDFORWARD_WHEEL_DIAMETER_MM     22.47f  // 実測58,019 pulse/mから換算した有効転がり径 D[mm]
