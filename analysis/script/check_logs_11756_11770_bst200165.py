"""Check the bst200=1.65 logs by complete autoStart set and run number."""
...
def main():
    ...
    summary_path = OUT_DIR / "log_11756_11770_bst200165_summary.csv"
    runs_path = OUT_DIR / "log_11756_11770_bst200165_by_autostart.csv"
    excluded_path = OUT_DIR / "log_11756_11770_bst200165_excluded_sets.csv"
