"""Check the latest normal-speed logs and retain stop-phase evidence."""
...
def main():
    ...
    summary_path = OUT_DIR / "log_11806_11820_goal_stop_summary.csv"
    runs_path = OUT_DIR / "log_11806_11820_goal_stop_by_autostart.csv"
    excluded_path = OUT_DIR / "log_11806_11820_goal_stop_excluded_sets.csv"
