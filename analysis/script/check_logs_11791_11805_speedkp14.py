"""Check the veloCtrl.kp=14 logs by complete autoStart set and run number."""
...
def main():
    ...
    summary_path = OUT_DIR / "log_11791_11805_speedkp14_summary.csv"
    runs_path = OUT_DIR / "log_11791_11805_speedkp14_by_autostart.csv"
    excluded_path = OUT_DIR / "log_11791_11805_speedkp14_excluded_sets.csv"
