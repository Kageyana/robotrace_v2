"""Check CA_SLIP_FRAC_FULL=0.70 logs by complete autoStart set."""
...
def main():
    ...
    summary_path = OUT_DIR / "log_11709_11728_slip_frac070_summary.csv"
    runs_path = OUT_DIR / "log_11709_11728_slip_frac070_by_autostart.csv"
    excluded_path = OUT_DIR / "log_11709_11728_slip_frac070_excluded_sets.csv"
