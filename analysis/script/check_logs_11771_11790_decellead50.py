"""Check the decelLeadMm=50 logs by complete autoStart set and run number."""
...
def main():
    ...
    summary_path = OUT_DIR / "log_11771_11790_decellead50_summary.csv"
    runs_path = OUT_DIR / "log_11771_11790_decellead50_by_autostart.csv"
    excluded_path = OUT_DIR / "log_11771_11790_decellead50_excluded_sets.csv"
