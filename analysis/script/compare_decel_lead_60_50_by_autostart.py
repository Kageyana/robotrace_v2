"""Compare decelLeadMm=60 and 50 by autoStart run number."""
...
CANDIDATE = ROOT / "log_11771_11790_decellead50_by_autostart.csv"
OUT = ROOT / "log_11709_11790_decelLead_60_50_comparison_by_autostart.csv"
...
def main():
    ...
    for run_number in (2, 3, 4, 5):
        base_rows = base[run_number]
        candidate_rows = candidate[run_number]
        row = {
    ...
    for row in output:
        print(
            ...
            f"p95={row['base_speed_error_abs_p95_mps_mean']:.3f}->{row['candidate_speed_error_abs_p95_mps_mean']:.3f} "
