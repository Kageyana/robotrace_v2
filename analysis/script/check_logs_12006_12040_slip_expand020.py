"""Validate CA_SLIP_EXPAND_2=0.20 logs and compare by autoStart run number."""
...
NEW_LOGS = list(range(12006, 12041))
...
def main() -> None:
    ...
    for set_id, group in enumerate(complete, 1):
        for log_number in group:
            if int(summaries[log_number]["autoStart"]) == 1:
                continue
            row = {"condition": "slip_expand_020", "set": set_id}
    ...
    excluded_rows = [{"condition": "slip_expand_020", **row} for row in excluded]

    base.write_csv(base.OUT_DIR / "log_12006_12040_slip_expand020_summary.csv", list(summaries.values()))
    write_csv(base.OUT_DIR / "log_12006_12040_slip_expand020_by_autostart.csv", run_rows)
    write_csv(base.OUT_DIR / "log_12006_12040_slip_expand020_comparison.csv", comparison)
    write_csv(base.OUT_DIR / "log_12006_12040_slip_expand020_sets.csv", set_rows)
    write_csv(base.OUT_DIR / "log_12006_12040_slip_expand020_excluded_sets.csv", excluded_rows)
