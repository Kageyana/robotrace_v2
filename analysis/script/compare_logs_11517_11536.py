"""Analyze the additional confirmation logs for MOTOR_COMMAND_NOMINAL_V=7.2 V."""
...
def main():
    ...
    outputs = {
        "summary": (OUT_DIR / "log_11517_11536_voltage_command72_confirm_summary.csv", rows),
        "sets": (OUT_DIR / "log_11517_11536_voltage_command72_confirm_sets.csv", set_rows),
        "metrics": (OUT_DIR / "log_11517_11536_voltage_command72_confirm_metrics.csv", metrics_rows),
    }
